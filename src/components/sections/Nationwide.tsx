...
export default function Nationwide({ locale, content }: Props) {
    ...
    <section className="section section--navy">
      <div className={`container ${styles.inner}`}>
        ...
        <div className={styles.content}>
          <h2 className={styles.headline}>{content.nationwide.headline}</h2>
          <p className={styles.body}>{content.nationwide.body}</p>
          <div className={styles.action}>
            <a
              ...
              onClick={() => trackWhatsAppClick("nationwide")}
            >
